...
CREATE TABLE IF NOT EXISTS PERSON_FIELDS (ID INT PRIMARY KEY, NAME VARCHAR2(255 CHAR), VALUE NUMBER, PERSON_ID INT, foreign key (PERSON_ID) references PERSON(ID));
